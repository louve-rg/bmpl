...
export const CONVERSATION_CONTEXTS = ['ORDER', 'VENDOR_ORDER', 'DELIVERY', 'SUPPORT_CASE'] as const;
...
export const CONVERSATION_PARTICIPANT_ROLES = ['CUSTOMER', 'VENDOR', 'DRIVER', 'SUPPORT'] as const;
 ...
 */
export const CONVERSATION_PAIRINGS = ['CUSTOMER_VENDOR', 'CUSTOMER_DRIVER', 'VENDOR_DRIVER', 'USER_SUPPORT'] as const;
