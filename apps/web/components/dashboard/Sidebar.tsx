...
const BASE_NAV: NavItem[] = [
  ...
  { label: 'Saved Products', href: '/wishlist', icon: 'M12 21s-7.5-4.9-10-9.4C.6 8.7 2 5.3 5.2 5.3c2 0 3.3 1.2 4.8 3 1.5-1.8 2.8-3 4.8-3 3.2 0 4.6 3.4 3.2 6.3C19.5 16.1 12 21 12 21Z' },
